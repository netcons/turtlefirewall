...
&ui_print_header( "$icons{ICON}{IMAGE}$text{'index_icon_manglerules'}", $text{'title'}, "" );
...
print "<br><br>";
&ui_print_footer("list_manglerules.cgi?table=connmarkpreroute&idx=$idx",$text{'index_manglerules'});
